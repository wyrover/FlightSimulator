...
EShaderError GLSLShader::CreateShaderFromSourceFile(LPCWSTR filename, EShaderType type)
{
...
void GLSLShader::SetShaderOwnerProgram(ShaderProgramHandle handle)
{
...
void GLSLShaderProgram::AttachAndCompileShaderFromFile(LPCWSTR filename, EShaderType type)
{
	...
	ShaderBase* shader = new GLSLShader();
